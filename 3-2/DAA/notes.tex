...
Let us find the complexity of Euclid's algorithm. In Number Theory, we proved that the number of steps is at most 5 times the number of digits in it's base 10 representation. This implies that it is $O(\log n)$.
