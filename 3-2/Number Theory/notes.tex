...
\begin{remark}
  This is an important function to remember. It can be found using the Sieve of Eratosthenes, and is useful in many combinatoric problems involving factors. 
\end{remark}
