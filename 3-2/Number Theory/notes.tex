...
From the Quadratic Reciprocity law, we can find the parity of $v_a$. Let $p$ be an odd prime and let $a$ be an odd positive integer coprime to $p$. Then for $k = 1, \cdots, p-1$, let $q_k, r_k$ denote the quotient and remainder of $ka$ upon division by $p$. Then:
\begin{enumerate}
